...
let foundAnimal = magicAnimals.filter(e => {
    if (e.id == id) {
        return e;
    }
});
updateAnimal.call(foundAnimal);
...
let array = ['being majestic', 'eating rainbows']
return updateAnimal.apply(foundAnimal[0], array);
// return updateAnimal(foundAnimal[0], array)
// return updateAnimal()
}
